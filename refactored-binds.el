...
(map!
 :map occur-mode-map
 :nv "<up>" #'previous-error-no-select
 :nv "<down>" #'next-error-no-select

 :nv "C-<right>" #'windmove-right
 :nv "C-<left>" #'windmove-left
 :nv "C-<down>" #'windmove-down
 :nv "C-<up>" #'windmove-up
...
(map! :map dired-mode-map
      :n  :desc "copy absolute filename of marked file(s)" "C-u Y" #'diredp-copy-abs-filenames-as-kill
      :localleader :n  :desc "copy absolute filename of marked file(s)" "f" #'diredp-copy-abs-filenames-as-kill
      :leader :prefix "f" :n "y" #'diredp-copy-abs-filenames-as-kill)
