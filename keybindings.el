...
(map!
 ...
 :i "S-SPC" #'my/save-and-change-to-normal
...
(map! :leader
  :nv
  :desc "search online" "sG" #'+lookup/online
...
(map! :localleader
      (:prefix ("e" "Evaluate stuff")
        (:map python-mode-map
          :desc "eval buffer" :n "b" #'python-shell-send-buffer
          :desc "eval file" :n "F" #'python-shell-send-file
          :desc "eval function" :n "f" #'python-shell-send-defun
          :desc "eval statement" :n "s" #'python-shell-send-statement
          :desc "eval region" :n "r" #'python-shell-send-region)
        (:map matlab-mode-map
          :desc "eval buffer" :n "b" (lambda () (interactive) (evil-goto-first-line) (evil-visual-line) (evil-goto-line) (matlab-shell-run-region))
          :desc "eval line" :n "l" (lambda () (interactive) (evil-visual-line) (matlab-shell-run-region))
          :desc "eval region" :n "r" #'matlab-shell-run-region)))
...
(map! :leader
        ...
        (:prefix ("i"  "insert stuff")
                ...
                (:prefix ("s" . "surround stuff")
                 ...
                 :desc "surround object with curly brackets" "\}" (kbd "ysio\}")
                ))
        ...
        (:prefix ("r" . "rectangle operations")
         ...
         (:prefix ("n" . "notes")
                :desc "search notes with xeft" "x" #'xeft
                )
...
(map! :map global-map
      :nv "'" #'evil-goto-mark
      :nv "M-#" #'dictionary-lookup-definition)
