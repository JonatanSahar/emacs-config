;;; themes-and-fonts.el -*- lexical-binding: t; -*-
(require-theme 'modus-themes)

;; Palette overrides: custom tweaks + the intense preset
...
(custom-set-faces!
  '(modus-themes-completion-match-0 :weight semibold :foreground "#808000"))
